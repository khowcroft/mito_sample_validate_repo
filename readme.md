...
**CSV format** (important is PID, acquisitions, acq_id):
PID, acquisitions,acq_id, extension
...
vis_file.png - comparison visualziation against database to PID_name samples if --compare_sample or just matching samples without --compare_sample
